...
class ip2country {
	...
	public function get_country_timezonename($ipaddr=''){
		
		$sql = "SELECT zone_name FROM zone WHERE country_code='".$this->get_country_code($ipaddr)."' LIMIT 1";
		...
		$this->country_timezone_name = $row['zone_name'];
...
#echo 'Your country code is ' .$ip2c->get_country_name('221.133.32.123');
?>
