...
$parser = new Parser(null,null,true,true);
$parser->SetCacheDir(__DIR__."/uascache/");

// print response data - array view
$useragent = 'Mozilla/5.0 (iPad; U; CPU OS 5_1 like Mac OS X; en-us) AppleWebKit/534.46 (KHTML, like Gecko) Version/5.1 Mobile/9B176 Safari/7534.48.3';
